module.exports = {
  ...
  '合并多服务器流量统计': 'Calculate the sum of Multi-Server Data Usage',
  '注册时间': 'Signup Date',
  '上次登录': 'Latest Signin',
  ...
  '天':'Day',
  '周':'Week',
  '从订单中选择类型': 'Choose from Orders',
  '新用户分组': 'User Group',
  '自定义可用服务器': 'Assign Server',
  '自定义分组订单': 'Set Group',
  '允许购买多个账号': 'Allow Purchasing Multi-Account',
  '显示公共的公告': 'Show Announcements',
  '今日流量排行': 'Data Ueage Ranking',
  '已绑定': 'Linked',
  '名称': 'Name',
  '网站短标题': 'Short Title',
  '主题颜色': 'Theme Primary Color',
  '主题第二颜色': 'Theme Secondary Color',
  '修改登录密码': 'Change Password',
  '确认': 'OK',
  '流量': 'Data Usage',
  '更改类型时保持过期时间不变': 'Keep Expire Date After Changes',
  '清除该账号流量': 'Clean data useage for this account',
  '到期自动删除': 'Delete this account after expired',
  '将改动变更到已有的账号': 'Assign the changes to the existing account',
  '自动激活': 'Auto Active',
  '续费允许更换套餐': 'Allow Change Data Plan',
  '自动删除延迟': 'Auto Remove Latency',
  '端口分配范围': 'Ports Range',
  '邀请获得时长': 'Awarded Bonus for Invatations',
  '最大邀请次数': 'Max of Invatation Limits',
  '访问次数': 'Visiting Limits',
};
